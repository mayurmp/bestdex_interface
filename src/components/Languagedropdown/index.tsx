...
export default function Languagedropdown({ langShortHand = false }: MenuProps) {
            ...
            clientType !== CLIENT_BEST_WALLET && (
              <LanguageContainer>
                ...
                {isMobile ? (
                  ...
                  <ChevronDown fontSize={'14px'} color={theme.darkMode ? theme.white : theme.black}></ChevronDown>
                )}
              </LanguageContainer>
            )
          ) : (
