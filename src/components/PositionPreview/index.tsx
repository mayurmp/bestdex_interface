...
export const PositionPreview = ({
  ...
  const sorted = typeof baseCurrency === 'object' ? baseCurrency?.name === currency0?.name : baseCurrency === currency0
        ...
        <RowBetween>
          <LightCard width="48%" padding="8px">
            <AutoColumn gap="4px" justify="center">
              ...
              <MouseoverTooltip text={formatTickPrice(priceLower, ticksAtLimit, Bound.LOWER)}>
                <ThemedText.MediumHeader textAlign="center">
                  <TextEllipsis maxWidth={isMobile ? '120px' : '200px'}>
          ...
          <LightCard width="48%" padding="8px">
            <AutoColumn gap="4px" justify="center">
              ...
              <MouseoverTooltip text={formatTickPrice(priceUpper, ticksAtLimit, Bound.UPPER)}>
                <ThemedText.MediumHeader textAlign="center">
                  <TextEllipsis maxWidth={isMobile ? '120px' : '200px'}>
