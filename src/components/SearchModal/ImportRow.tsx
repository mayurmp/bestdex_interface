import { Token, Currency } from '@tech-alchemy/best-dex/sdk-core'
  ...
  return (
    <TokenSection style={style}>
      ...
      <AutoColumn gap="4px" style={{ opacity: dim ? '0.6' : '1' }}>
        <AutoRow onClick={onSelect ? () => onSelect(token) : () => console.log('no click handler present')}>
      ...
      {!isActive && !isAdded ? (
        ...
        <RowFixed style={{ minWidth: 'fit-content', cursor: 'pointer' }}>
          <CheckIcon />
