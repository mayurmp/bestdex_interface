...
const MenuFlyout = styled.span`
  ...
  box-shadow: 0px 8px 24px rgb(12 93 158 / 10%), 0px 6px 24px rgb(39 34 36 / 10%);
  border-radius: 12px;
  display: flex;
        ...
        <ModalContentWrapper>
          <AutoColumn gap="lg">
            ...
            <AutoColumn gap="lg" style={{ padding: '0 2rem' }}>
              ...
              <Text fontWeight={600} color="red" fontSize={16}>
      ...
      {open && (
        <MenuFlyout>
          <AutoColumn gap="md" style={{ padding: '1rem' }}>
            ...
            {/* commenting API mode as we dont have support for API now */}
            {/* {chainId === SupportedChainId.MAINNET && (
              <RowBetween>
                <RowFixed>
                  ...
                  <QuestionHelper
                    text={<Trans>Use the BestDex Labs API to get better pricing through a more efficient route.</Trans>}
                  />
                </RowFixed>
                <Toggle
