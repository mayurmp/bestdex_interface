  ...
  return (
    <Wrapper>
      <Section inline={inline}>
        ...
        <ConfirmedIcon inline={inline}>
          <ArrowUpCircle strokeWidth={0.5} size={inline ? '40px' : '90px'} color={theme.bydefault} />
        </ConfirmedIcon>
        <AutoColumn gap="12px" justify={'center'}>
          <Text fontWeight={500} fontSize={20} textAlign="center">
          ...
          {chainId && hash && (
            ...
            >
              <Text fontWeight={500} fontSize={14} color={theme.bydefault}>
                <Trans>View on Explorer</Trans>
              </Text>
            </ExternalLink>
          )}
          {currencyToAdd && library?.provider?.isMetaMask && (
            <Button type="SECONDARY" onClick={addToken} backgroundColor={'#e6e6e6'} fontColor="#555555">
              {!success ? (
                <RowFixed>
                  <MouseoverTooltip text={<Trans>Add {currencyToAdd.symbol} token to Metamask</Trans>}>
                    <TextEllipsis>
                      <Trans>Add {currencyToAdd.symbol} token to Metamask</Trans>
                    </TextEllipsis>
                  </MouseoverTooltip>
                ...
                <RowFixed>
                  <Trans>Added {currencyToAdd.symbol} token to Metamask </Trans>
                  <CheckCircle size={'16px'} stroke={theme.secondary3} style={{ marginLeft: '6px' }} />
                </RowFixed>
              )}
            </Button>
          )}
