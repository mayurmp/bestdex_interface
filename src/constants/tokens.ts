import { Ether, Token, WETH9 } from '@tech-alchemy/best-dex/sdk-core'
...
export const LOCK = new Token(
  SupportedChainId.SEPOLIA,
  '0x9cc1193566840127D9F74fbd836A7665AD89f8f2',
  18,
  'LOCK',
  'LockToken'
)
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
  ...
  [SupportedChainId.BINANCE_TESTNET]: new Token(
    SupportedChainId.BINANCE_TESTNET,
...
// export const BINANCE_BNB_ADDRESS = '0xB8c77482e45F1F44dE1745F52C74426C631bDD52'
export const MaticTokenInfo = {
  name: 'Matic',
  symbol: 'MATIC',
}
export const BinanceTokenInfo = {
  name: 'BNB',
  symbol: 'BNB',
}
...
export const ERC20_MATIC_ADDRESS = '0x0000000000000000000000000000000000001010'
