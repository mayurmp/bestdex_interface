...
import { FeeAmount, NonfungiblePositionManager } from '@tech-alchemy/best-dex/v3-sdk'
...
import { GreyCard, OutlineCard, YellowCard } from '../../components/Card'
...
export default function AddLiquidity({
  ...
  }, [baseCurrency?.name, quoteCurrency, feeAmount])
  ...
  const isTransactionPending = attemptingTxn || pendingApprovalStateA || pendingApprovalStateB
  ...
  const Buttons = () =>
    addIsUnsupported ? (
      ...
      //  <ButtonLight onClick={toggleWalletModal} $borderRadius="12px" padding={'12px'}> <Trans>Connect Wallet</Trans></ButtonLight>
      <Button
        type="SECONDARY"
        size="XLARGE"
        center={true}
                  ...
                  <RightContainer gap="lg">
                    ...
                    >
                                  ...
                                  <ThemedText.Yellow ml="12px" fontSize="13px" margin={0} fontWeight={400}>
                                    <Trans>
                                      ...
                                      <ExternalLink
                                        ...
                                        href={
                                          'https://help.bestdex.com/en/articles/5434296-can-i-provide-liquidity-over-the-full-range-in-v3'
                                        }
                                      >
                                        here
                                      </ExternalLink>
                      ...
                      {invalidRange ? (
                        <YellowCard padding="8px 12px" $borderRadius="12px">
                          <RowBetween>
                            <AlertTriangle stroke={theme.yellow3} size="18px" style={{ marginTop: '-18px' }} />
                            <ThemedText.Yellow ml="12px" fontSize="12px">
