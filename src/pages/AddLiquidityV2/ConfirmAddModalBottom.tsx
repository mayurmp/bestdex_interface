...
import { Currency, CurrencyAmount, Fraction, Percent } from '@tech-alchemy/best-dex/sdk-core'
...
export function ConfirmAddModalBottom({
  ...
  return (
    <>
      ...
      <ButtonPrimary disabled={disabled} style={{ margin: '20px 0 0 0' }} onClick={onAdd}>
