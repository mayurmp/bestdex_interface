...
import { CurrencyAmount, Token } from '@tech-alchemy/best-dex/sdk-core'
    ...
    <PageWrapper gap="lg" justify="center">
            ...
            <AutoColumn gap="md">
              <RowBetween>
                <ThemedText.White fontWeight={600}>
                  <Trans>Step 1. Get BD LP Liquidity tokens</Trans>
                </ThemedText.White>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <ThemedText.White fontSize={14}>
                  <Trans>
                    BD LP LP tokens are required. Once you&apos;ve added liquidity to the {currencyA?.symbol}-
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
            ...
            <CardSection>
              ...
              <AutoColumn gap="md">
                ...
                <RowBetween style={{ alignItems: 'baseline' }}>
                  ...
                  <ThemedText.White>
                    <Trans>
                      BD LP {currencyA?.symbol}-{currencyB?.symbol}
                    </Trans>
                  </ThemedText.White>
                </RowBetween>
              </AutoColumn>
            ...
            {stakingInfo && stakingInfo.active && (
              <ButtonPrimary padding="8px" $borderRadius="8px" width="160px" onClick={handleDepositClick}>
                {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? (
                  ...
                  <Trans>Deposit BD LP LP Tokens</Trans>
                )}
              </ButtonPrimary>
            )}
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : !stakingInfo?.active ? null : (
          <ThemedText.Main>
            <Trans>{userLiquidityUnstaked.toSignificant(6)} BD LP LP tokens available</Trans>
          </ThemedText.Main>
        )}
      </PositionInfo>
    </PageWrapper>
