...
import { Token } from '@tech-alchemy/best-dex/sdk-core'
      ...
      <BodyWrapper style={{ padding: 24 }}>
        <AutoColumn gap="16px">
          <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
            ...
            <div>
              <QuestionHelper text={<Trans>Migrate your liquidity tokens from BestDex V2 to BestDex V3.</Trans>} />
            </div>
          </AutoRow>

          <ThemedText.Body style={{ marginBottom: 8, fontWeight: 400 }}>
            <Trans>
              For each pool shown below, click migrate to remove your liquidity from BestDex V2 and deposit it into
              BestDex V3.
            </Trans>
          </ThemedText.Body>
          ...
          <AutoColumn justify={'center'} gap="md">
            <Text textAlign="center" fontSize={14} style={{ padding: '.5rem 0 .5rem 0' }}>
              <Trans>
                Don’t see one of your v2 positions? {/* /find?origin=/migrate/v2 */}
