...
import { ChevronDown, ChevronsRight, Inbox, Layers, PlusCircle } from 'react-feather' // BookOpen
...
export default function Pool({ history }: RouteComponentProps) {
  /**
   * pointing to Pool v2 by default
   */
  useEffect(() => {
    if (defaultVersion === VersionType.v2) {
      history.push('/pool/v2')
    }
  }, [history])
