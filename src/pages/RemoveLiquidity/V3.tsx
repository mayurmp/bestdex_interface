...
import { NonfungiblePositionManager } from '@tech-alchemy/best-dex/v3-sdk'
...
const ButtonConfirmedStyle = styled(ButtonConfirmed)`
...
`
const ButtonPrimaryStyle = styled(ButtonConfirmedStyle)``
  ...
  function modalHeader() {
    return (
      <AutoColumn gap={'sm'} style={{ padding: '16px' }}>
        ...
        <ButtonPrimaryStyle mt="16px" onClick={burn}>
          <Trans>Remove</Trans>
        </ButtonPrimaryStyle>
      </AutoColumn>
    )
