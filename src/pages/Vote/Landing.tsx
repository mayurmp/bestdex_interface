              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <ThemedText.White fontWeight={600}>
                    <Trans>BestDex Governance</Trans>
                  </ThemedText.White>
                </RowBetween>
                <RowBetween>
                  <ThemedText.White fontSize={14}>
                    <Trans>
                      UNI tokens represent voting shares in BestDex governance. You can vote on each proposal yourself or
                ...
                >
                  <ThemedText.White fontSize={14}>
                    <Trans>Read more about BestDex governance</Trans>
                  </ThemedText.White>
                </ExternalLink>
              </AutoColumn>
            </CardSection>
