...
import { abi as GOV_ABI } from '@tech-alchemy/best-dex/governance/build/GovernorAlpha.json'
import { CurrencyAmount, Token } from '@tech-alchemy/best-dex/sdk-core'
import { POLYGON_PROPOSAL_TITLE } from 'constants/proposals/polygon_proposal_title'
import { SWAP_GRANTS_PROPOSAL_DESCRIPTION } from 'constants/proposals/uniswap_grants_proposal_description'
import {
    ...
    return {
      data: proposalsCallData.map((proposal, i) => {
        ...
        if (startBlock === UNISWAP_GRANTS_START_BLOCK) {
          description = SWAP_GRANTS_PROPOSAL_DESCRIPTION
        }
